      ...
      <div class="row">
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img
                src="{{ url('images/categories-gadget.svg') }}"
                alt=""
                class="w-100"
              />
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img
                src="{{ url('images/categories-furniture.svg') }}"
                alt=""
                class="w-100"
              />
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img
                src="{{ url('images/categories-makeup.svg') }}"
                alt=""
                class="w-100"
              />
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img
                src="{{ url('images/categories-sneaker.svg') }}"
                alt=""
                class="w-100"
              />
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img
                src="{{ url('images/categories-tools.svg') }}"
                alt=""
                class="w-100"
              />
        ...
        >
          <a href="#" class="component-categories d-block">
            <div class="categories-image">
              <img src="{{ url('images/categories-baby.svg') }}" alt="" class="w-100" />
